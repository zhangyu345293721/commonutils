...
public class TreeTool {
    ...
    public static TreeNode constructTree(Integer[] nums) {
        ...
        while (restLength > 0) {// 只有最后一行可以不满，其余行必须是满的
...
//            }
     ...
     * @param node 遍历的节点
     */
    public static void postOrderTraverse(TreeNode node, List<Integer> list) {
        if (node == null)
            return;
     ...
     * 须要辅助数据结构：栈
     */
    public static List<Integer> depthOrderTraversal(TreeNode root) {
